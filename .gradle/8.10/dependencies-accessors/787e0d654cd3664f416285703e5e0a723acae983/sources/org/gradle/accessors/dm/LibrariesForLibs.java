...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    /**
     * Dependency provider for <b>obj</b> with <b>de.javagl:obj</b> coordinates and
     * with version reference <b>obj</b>
     * <p>
     * This dependency was declared in catalog libs.versions.toml
     */
    public Provider<MinimalExternalModuleDependency> getObj() {
        return create("obj");
    }

    /**
     * Dependency provider for <b>opengl</b> with <b>androidx.opengl:opengl</b> coordinates and
     * with version reference <b>opengl</b>
     * <p>
     * This dependency was declared in catalog libs.versions.toml
     */
    public Provider<MinimalExternalModuleDependency> getOpengl() {
        return create("opengl");
    }

    /**
     * Dependency provider for <b>ux</b> with <b>com.google.ar.sceneform:ux</b> coordinates and
     * with version reference <b>ux</b>
     * <p>
     * This dependency was declared in catalog libs.versions.toml
     */
    ...
    public static class SceneformUxLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        ...
        /**
         * Dependency provider for <b>v1160</b> with <b>com.google.ar.sceneform.ux:sceneform-ux</b> coordinates and
         * with version reference <b>sceneformUxVersion</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getV1160() {
            return create("sceneform.ux.v1160");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>obj</b> with value <b>0.4.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getObj() { return getVersion("obj"); }

        /**
         * Version alias <b>opengl</b> with value <b>1.1.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getOpengl() { return getVersion("opengl"); }
        ...
        /**
         * Version alias <b>sceneformUxVersion</b> with value <b>1.16.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>ux</b> with value <b>1.16.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getUx() { return getVersion("ux"); }
